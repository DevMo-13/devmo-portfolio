					...
					<p>
						...
						<a className='linkedin' href='https://www.linkedin.com/in/moniquecinatl/' target='_blank' rel='noreferrer'>
							<svg className={styles.svg} version='1.1' id='regular' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 512 512'>
								...
								<path fill='#225588' className='st0' d='M23.9,159.6c-30.3,0-9.6,33.8-16,336.4c0,8.8,7.2,16,16,16h99.5c30.3,0,9.6-33.8,16-336.4
									C139.5,147.9,99.3,164.2,23.9,159.6z M107.5,480H39.9V191.6h67.5V480z'/>
								<path fill='#225588' className='st0' d='M73.6,0c-97.6,0-97,147.8,0,147.8C170.6,147.8,171.4,0,73.6,0z M73.6,115.8c-54.8,0-55.3-83.8,0-83.8

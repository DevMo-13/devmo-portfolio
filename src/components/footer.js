	...
	return (
		<section className='footer section'>
			...
			<div className='social' align='center'>
				<p>
					<a className='github' href='https://github.com/DevMo-13' target='_blank'>
						<svg width='3.5em' version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 512 512' xmlspace='preserve'>
							<path fill='#225588' class='st0' d='M256,0C115.3,0,0,116.3,0,257c0,139.9,114.3,255,256,255c141.6,0,256-114.9,256-255C512,116.3,396.7,0,256,0z
					...
					<a className='linkedin' href='https://www.linkedin.com/in/moniquecinatl/' target='_blank'>
						<svg width='3.5em' version='1.1' id='regular' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 512 512' xmlspace='preserve'>
							<path fill='#225588' class='st0' d='M396.6,512c2.2,0,101.6,0,99.4,0c8.8,0,16-7.2,16-16c-7.5-167.6,39.3-344.5-135.2-344.5
							...
							<path fill='#225588' class='st0' d='M23.9,159.6c-30.3,0-9.6,33.8-16,336.4c0,8.8,7.2,16,16,16h99.5c30.3,0,9.6-33.8,16-336.4
								C139.5,147.9,99.3,164.2,23.9,159.6z M107.5,480H39.9V191.6h67.5V480z'/>
							<path fill='#225588' class='st0' d='M73.6,0c-97.6,0-97,147.8,0,147.8C170.6,147.8,171.4,0,73.6,0z M73.6,115.8c-54.8,0-55.3-83.8,0-83.8
								C129,32,128.3,115.8,73.6,115.8z'/>
						</svg>
					</a>
					<a className='twitter' href='https://twitter.com/moniquecinatl' target='_blank'>
						<svg width='3.75em' version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 512 512' xmlspace='preserve'>
							<path fill='#225588' class='st0' d='M512,103c-32.2,1.5-31.5,1.4-35.1,1.7l19.1-54.5c0,0-59.5,21.9-74.6,25.8c-39.6-35.6-98.6-37.2-140.7-11.3
					...
					<a className='email' href='mailto:moniquecinatl@gmail.com' target='_blank'>
						<svg width='3.75em' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xmlspace="preserve">
			...
			<div className='copyright' align='center'>			
				...
				<img alt='logo' src='favicon.ico' width='50em'/>
			</div>
		</section>
	);
}
